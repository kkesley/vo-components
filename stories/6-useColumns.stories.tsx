...
import { useColumns, calculateColumnOriginalIndex } from '../src'
      ...
      {chunkedItems.map((chunk, chunkIndex) => (
         <div className="column is-4 is-6-tablet">
          {chunk.map((item, itemIndex) => (
              ...
              <div className="card">
                  <div className="card-content"><p>{item}</p>
              <p>
                Original Index:&nbsp;
...
export const ColumnOverride = () => {
    const { chunkedItems, columnCount } = useColumns({ items, columnOverride: {desktop: 6, tablet: 4, phone: 2 } })
    return (
      <div className="container">
        <p>Registered column: {columnCount}</p>
